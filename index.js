...
// ANSWER:might be numbers .map ? and square each number, if numbers is a set size always it would be o(1)
...
// CODE HERE 
function noCachesqr(num) {
  let answer = num * num
  return answer
}
const mySqr = new Squared
/*
    Before you see how much time they take, make a 
    guess as to if one will be faster.
*/

// ANSWER: the one with the cache will be faster
